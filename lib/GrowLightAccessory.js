...
class GrowLightAccessory {
    ...
    setupListener() {
        ...
        this.listener = fork(__dirname+"/GrowLightListener.js", [this.id, this.key]);
    ...
    initializeCharacteristics() {
        ...
        this.characteristics.vegBrightness.minStep = 25;
        ...
        this.characteristics.bloomBrightness.minStep = 25;
